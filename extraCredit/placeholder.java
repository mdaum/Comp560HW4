...
public class placeholder {   
	...
	public static void main(String[] args){
		...
		svm_problem Clutch2 = constructProblem(numTrainingItems, vectorLength2);
		svm_problem Hobo2 = constructProblem(numTrainingItems, vectorLength2);
		svm_problem Flats2 = constructProblem(numTrainingItems, vectorLength2);
		svm_problem Pumps2 = constructProblem(numTrainingItems, vectorLength2);
		...
		fillTrainingArrays(Clutch2, Hobo2, Flats2, Pumps2, "bags_clutch", 305, 1000, !isHistogram);
		System.out.println(labelcount - oldLabels);
		oldLabels = labelcount;
		fillTrainingArrays(Clutch2, Hobo2, Flats2, Pumps2, "bags_hobo", 85, 782, !isHistogram);
		System.out.println(labelcount - oldLabels);
		oldLabels = labelcount;
		fillTrainingArrays(Clutch2, Hobo2, Flats2, Pumps2, "womens_flats", 299, 996, !isHistogram);
		System.out.println(labelcount - oldLabels);
		oldLabels = labelcount;
		fillTrainingArrays(Clutch2, Hobo2, Flats2, Pumps2, "womens_pumps", 48, 745, !isHistogram);	
		System.out.println(labelcount - oldLabels);
		oldLabels = labelcount;
		System.out.println("Done. Teaching svm(s)");
			...
			svm_parameter param2 = constructParameter(!isHistogram,isLinear);
			...
			svm_model trainedClutch2 =svm.svm_train(Clutch2,param2);
			System.out.println("Trained Clutch");
			svm_model trainedHobo2 =svm.svm_train(Hobo2, param2);
			System.out.println("Trained Hobo");
			svm_model trainedFlats2 =svm.svm_train(Flats2, param2);
			System.out.println("Trained Flats");
			svm_model trainedPumps2 =svm.svm_train(Pumps2,param2);
			System.out.println("Trained Pumps");
			...
			ArrayList<Decision>decisions2=new ArrayList<Decision>(); 
			evaluateClass(trainedClutch2, trainedHobo2, trainedFlats2, trainedPumps2, "bags_clutch", "Testing", 2, 1000, decisions2, !isHistogram,args);
			evaluateClass(trainedClutch2, trainedHobo2, trainedFlats2, trainedPumps2, "bags_hobo", "Testing", 2, 1000, decisions2, !isHistogram,args); //will just have lots of continues here
			evaluateClass(trainedClutch2, trainedHobo2, trainedFlats2, trainedPumps2, "womens_flats", "Testing", 2, 1000, decisions2, !isHistogram,args); 
			evaluateClass(trainedClutch2, trainedHobo2, trainedFlats2, trainedPumps2, "womens_pumps", "Testing", 2, 1000, decisions2, !isHistogram,args);
			
			ArrayList<Decision> newDecisions = new ArrayList<Decision>();
			for(int i = 0;i < decisions.size();i++)
			{
				double[] newClutchProbs = {(decisions.get(i).clutchProbs[0]+decisions2.get(i).clutchProbs[0])/2,(decisions.get(i).clutchProbs[1]+decisions2.get(i).clutchProbs[1])/2};
				double[] newHoboProbs = {(decisions.get(i).hoboProbs[0]+decisions2.get(i).hoboProbs[0])/2,(decisions.get(i).hoboProbs[1]+decisions2.get(i).hoboProbs[1])/2};
				double[] newPumpsProbs = {(decisions.get(i).pumpsProbs[0]+decisions2.get(i).pumpsProbs[0])/2,(decisions.get(i).pumpsProbs[1]+decisions2.get(i).pumpsProbs[1])/2};
				double[] newFlatsProbs = {(decisions.get(i).flatsProbs[0]+decisions2.get(i).flatsProbs[0])/2,(decisions.get(i).flatsProbs[1]+decisions2.get(i).flatsProbs[1])/2};


				Decision newD = new Decision(newClutchProbs, 1 ,newHoboProbs,1,newFlatsProbs,1,newPumpsProbs,1,decisions.get(i).filepath);
				newD.makeDecision();
				newDecisions.add(newD);
				if(newD.interesting)numInteresting++;
			}
			...
			for (Decision decision : newDecisions) {
